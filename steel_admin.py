...
def show_all_material(my_frame1):
    ...
    # Select and delete from tree function.
    def delete():
        # Db connect.
        mydb = mysql.connector.connect(host="127.0.0.1",
                                       user="root",
