...
class LoginScreen(tk.Toplevel):
    def __init__(self, child):
        ...
        self.user_name_labelame_geterify = StringVar()
        ...
        # Username entry.
        self.user_name_labelame_entry1 = Entry(self, textvariable=self.user_name_labelame_geterify)
        self.user_name_labelame_entry1.pack()
    ...
    def login_verify(self, event=None):
        user_name_labelame_get = self.user_name_labelame_geterify.get()
        ...
        sql = "SELECT * FROM login WHERE BINARY username = '%s'" \
              " AND BINARY userpass = '%s'" % (user_name_labelame_get, hashlib.md5(str.encode(password_get)).hexdigest())
        ...
        if my_cursor.fetchone():
            ...
            # Open admin screen
            self.open_admin_screen(user_name_labelame_get)
